...
1. Open the app.
2. Browse the Fixtures, Groups, Teams, Venues, and Knockout sections.
3. Open a fixture and tap the Calendar button.
4. Open a fixture and tap the Reminder button.
5. Accept the iOS permission prompts if shown.
